...
//根据不同的颜色格式,定义帧缓存数组
#ifdef USE_GCC		//GCC编译使用
	__attribute__ ((section(".sdram_bss"))) u16 ltdc_lcd_framebuf[1280][800];	//默认RGB565

//MDK_KEIL下使用
#elif LCD_PIXFORMAT==LCD_PIXFORMAT_ARGB8888||LCD_PIXFORMAT==LCD_PIXFORMAT_RGB888
